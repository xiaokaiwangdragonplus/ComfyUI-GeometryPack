...
import { getExtensionAssetUrl } from "./utils/path_utils.js";
...
async function loadMappings() {
    const paths = [
        getExtensionAssetUrl('js/backend_mappings.json'),
        getExtensionAssetUrl('js/backend_mappings.json').replace('ComfyUI-GeometryPack', 'comfyui-geometrypack'),
    ];
